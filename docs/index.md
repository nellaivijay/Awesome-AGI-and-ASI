...
| **Build** | [Frameworks](build/frameworks.md) | 35+ agent frameworks -- next-gen, established, and specialized |
| | [Agents](build/agents.md) | Coding, research, computer-use, embodied, and enterprise agents |
| | [Physical AI](build/physical-ai.md) | Humanoid robotics, VLA models, simulation platforms |
...
| | [Distributed Training](infrastructure/distributed-training.md) | ColossalAI, DeepSpeed, Megatron-LM |
| | [Prompt Engineering](infrastructure/prompt-engineering.md) | CoT, ToT, GoT, advanced techniques |
| **Safety** | [Safety & Alignment](safety/safety-alignment.md) | RLHF, DPO, interpretability, AI governance |
