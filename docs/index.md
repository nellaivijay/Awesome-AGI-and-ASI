...
<div class="hero-section">
  <h1>🤖 Awesome AGI & ASI</h1>
  <p>The frontier of artificial intelligence research — from AI to AGI to ASI. Curated resources for builders and researchers shaping the future of intelligence.</p>
</div>
...
| | Topic | What's Inside |
|---|---|---|
| **Understand** | [AI, AGI, and ASI](understand/ai-agi-asi.md) | Definitions, comparison table, DeepMind's AGI levels, state of the field |
...
| **Build** | [Frameworks](build/frameworks.md) | LAMs, MCP/A2A protocols, 30+ agent frameworks |
...
| **Infrastructure** | [LLM Frameworks](infrastructure/llm-frameworks.md) | Orchestration, platforms, structured output, observability |
...
| **Safety** | [Safety & Alignment](safety/safety-alignment.md) | Superalignment, RLHF, DPO, interpretability, AI governance |
| **Research** | [Papers & Blogs](research/papers-blogs.md) | 60+ papers on frontier models, reasoning, agents |
