---
description: "Getting models from research to production. High-performance inference engines, serving frameworks, and optimization tools that make LLMs fast, cost-efficient, and scalable."
keywords: "LLM deployment, model serving, inference optimization, vLLM, TGI, ONNX, quantization"
---
...
|| [KubeVirt](https://kubevirt.io/) | Packages virtual machines as Kubernetes objects for management together with containers. Enables VM workloads alongside containerized AI services. | [kubevirt.io](https://kubevirt.io/) |